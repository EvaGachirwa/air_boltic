...
load_to_database(
    df=aeroplane_model_df,
    table_name="aeroplane_models",
    engine=ENGINE,
    disposation="append",
)
...
load_to_database(
    df=customer_group_df,
    table_name="customer_groups",
    engine=ENGINE,
    disposation="append",
)
load_to_database(
    df=customer_df, table_name="customers", engine=ENGINE, disposation="append"
)
load_to_database(
    df=aeroplane_df, table_name="aeroplanes", engine=ENGINE, disposation="append"
)
